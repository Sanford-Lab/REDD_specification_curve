...
source(here::here("code", "schart.R"))

matching_spec_chart <- function(project_name, results, spec_order = "asis", color = "black") {
  ...
  text(x=mean(1:nrow(schart_results)), y=max(schart_results$upper), project_name, col="black", font=2)
