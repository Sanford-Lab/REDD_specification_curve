# Author: Henry Chen
# Date: 7/25/2023
# Function: Applies matching. Parameters include start year of project and project name

match_data <- function(project_name, start_year, method = "nearest", distance = "logit", ratio = 5) {
